...
module.exports = function PB(config) {
    ...
    pb.AdminIPFilter                  = require(path.join(config.docRoot, '/include/security/network/admin_ip_filter.js'))(pb);
    ...
    pb.BaseController      = require(path.join(config.docRoot, '/plugins/pencilblue/controllers/base_controller.js'))(pb);
    pb.BaseActionController= require(path.join(config.docRoot, '/controllers/api/base_action_controller.js'))(pb);
    pb.BaseApiController   = require(path.join(config.docRoot, '/plugins/pencilblue/controllers/api/base_api_controller.js'))(pb);
    ...
    pb.ApiActionController = require(path.join(config.docRoot, '/plugins/pencilblue/controllers/api/api_action_controller.js'))(pb);
