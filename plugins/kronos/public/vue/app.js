...
var app = new Vue({
    ...
    data: {
        ...
        '\n' +
        'Aliquam sed tristique sapien, a efficitur ligula. Pellentesque velit ante, dictum quis est nec, ornare efficitur arcu. Sed finibus, lectus a ullamcorper lacinia, justo lectus mattis diam, eget elementum odio eros ut nunc. Duis vel odio venenatis, porta lacus et, bibendum orci. Donec ornare metus consequat augue commodo, at lacinia sem pretium. Proin varius, lectus vitae egestas bibendum, lectus justo eleifend felis, id tempus metus massa vitae enim. Nam ut cursus justo. Integer in lacus semper, pretium tellus ac, bibendum metus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc fermentum tortor non neque posuere semper. Integer finibus urna ante, a pretium felis mattis a. Donec sed massa sagittis, varius arcu ut, rhoncus orci. Aliquam commodo lacus eget leo convallis euismod. Vivamus interdum purus risus, nec fermentum massa facilisis non. Maecenas diam ante, rutrum vel euismod quis, ornare sit amet odio. In congue neque pretium neque rhoncus, et consectetur mi accumsan.',
        adminNav: [],
        cluster: []
    },
    methods: {
